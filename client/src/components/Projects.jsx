      ...
      <Container className="projects">
        ...
        <Row>
          {/* <Fade top={true} duration={1200} delay={400} distance='50px'> */}
            ...
            text='RestO! is your friendly food ordering web application, which allows users to place orders and receive SMS notifications about their order status. It was a group project (myself and 2 others) built in one week using Node, Express, PSQL, Twilio, JavaScript, jQuery, HTML and SASS. My main contributions were to the backend routing, database interaction, and the frontend requests for the cart functions.'
            />
          {/* </Fade> */}
        </Row>
        <Row>
